package com.pt.glancewords.widget.ui.actions
...
// This means that the widget will be blinking. First, it would show loading state then load cached glancewords and then show fresh synchronized glancewords.
