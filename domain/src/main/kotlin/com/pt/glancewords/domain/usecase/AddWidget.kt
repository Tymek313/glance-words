...
interface AddWidget {
    suspend operator fun invoke(widgetToAdd: WidgetToAdd): WidgetId

    data class WidgetToAdd(val widgetId: WidgetId, val sheet: NewSheet)
}

class DefaultAddWidget(private val widgetRepository: WidgetRepository, private val sheetRepository: SheetRepository) : AddWidget {

    override suspend fun invoke(widgetToAdd: WidgetToAdd): WidgetId {
