...
class DefaultInvokeTest {

    private lateinit var synchronizer: DefaultSynchronizeWords
    ...
    fun setUp() {
        ...
        synchronizer = DefaultSynchronizeWords(
    ...
    fun `when words are synchronized_given widget do not exist_then false is returned`() = runTest {
        ...
        val syncSucceeded = synchronizer.invoke(WIDGET_ID_TO_SYNCHRONIZE)
    ...
    fun `when words are synchronized_given widget exists_then all steps are executed in the correct order`() = runTest {
        ...
        synchronizer.invoke(WIDGET_ID_TO_SYNCHRONIZE)
